...
const items: Item[] = [
  ...
  { 
    ...
    name: 'Blazer', 
    price: 12.99, 
    description: 'Single blazer or jacket', 
    categoryId: 'formal' 
  },
  { 
    id: 'formal_dress', 
    name: 'Formal Dress', 
    price: 15.99, 
    description: 'Evening or formal dresses', 
    categoryId: 'formal' 
  },
  { 
    id: 'tuxedo', 
    name: 'Tuxedo', 
    price: 24.99, 
    description: 'Full tuxedo cleaning', 
    categoryId: 'formal' 
  },
  ...
  { 
    ...
    name: 'Silk Blouse', 
    price: 9.99, 
    description: 'Delicate silk tops', 
    categoryId: 'delicate' 
  },
  { 
    id: 'wool_sweater', 
    name: 'Wool Sweater', 
    price: 11.99, 
    description: 'Wool or cashmere sweaters', 
    categoryId: 'delicate', 
    popular: true 
  },
  { 
  ...
  { 
    ...
    name: 'Winter Coat', 
    price: 19.99, 
    description: 'Heavy winter coats', 
