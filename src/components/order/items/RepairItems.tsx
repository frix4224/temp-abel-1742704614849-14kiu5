...
const items: Item[] = [
  ...
  { 
    ...
    price: 3.99, 
    description: 'Replace missing buttons', 
    categoryId: 'basic', 
    popular: true 
  },
  { 
    ...
    name: 'Simple Hem', 
    price: 6.99, 
    description: 'Basic hem adjustment', 
    categoryId: 'basic', 
    popular: true 
  },
  { 
  ...
  { 
    ...
    price: 12.99, 
    description: 'Full zipper replacement', 
    categoryId: 'advanced', 
    popular: true 
  },
  { 
    ...
    name: 'Lining Repair', 
    price: 'custom', 
    description: 'Fix or replace lining', 
    categoryId: 'advanced' 
  },
  { 
    id: 'leather_repair', 
    name: 'Leather Repair', 
    price: 'custom', 
    description: 'Professional leather fixing', 
    categoryId: 'advanced' 
  },
  ...
  { 
    ...
    price: 8.99, 
    description: 'Shorten or lengthen', 
    categoryId: 'alterations' 
  },
  { 
    id: 'shoulders', 
    ...
    price: 'custom', 
    description: 'Adjust shoulder fit', 
    categoryId: 'alterations' 
  }
];
