...
const items: Item[] = [
  ...
  { 
    ...
    name: 'Shirt', 
    price: 4.99, 
    description: 'Business or casual shirts', 
    categoryId: 'tops', 
    popular: true 
  },
  { 
  ...
  { 
    ...
    name: 'Polo Shirt', 
    price: 4.49, 
    description: 'Polo or golf shirts', 
    categoryId: 'tops' 
  },
  { 
    id: 'blouse', 
  ...
  { 
    ...
    name: 'Pants', 
    price: 5.99, 
    description: 'Regular or dress pants', 
    categoryId: 'bottoms', 
    popular: true 
  },
  { 
  ...
  { 
    ...
    name: 'Skirt', 
    price: 5.99, 
    description: 'Regular or pleated skirts', 
    categoryId: 'bottoms' 
  },
  ...
  { 
    ...
    name: 'Maxi Dress', 
    price: 9.99, 
    description: 'Full-length dresses', 
    categoryId: 'dresses' 
  },
  ...
  { 
    ...
    name: 'Light Jacket', 
    price: 7.99, 
    description: 'Spring/fall jackets', 
